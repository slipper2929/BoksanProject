                    ...
                    <ul class="b_header_nav_menu">
                        <li> <!--상품-->
                            ...
                            <ul class="b_header_nav_menu_medium">
                                ...
                                <li> <!--상품분류등록-->
                                    <p><a href="./group_add.jsp">상품분류등록</a></p>
                                </li> <!--상품분류등록끝-->
                                <li> <!--상품조회-->
                                    <p><a href="#">상품조회</a></p>
                            ...
                            <ul class="b_header_nav_menu_medium">
                                <li>
                                    ...
                                    <ul class="b_header_nav_menu_small">
                                        ...
                                        <li>
                                            <p><a href="./move_order_list.jsp">이동목록</a></p>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                        ...
                        <li> <!--입고-->
                            ...
                            <ul class="b_header_nav_menu_medium">
                                <li>
                                    <p><a href="./arrive_list.jsp">입고대기목록</a></p>
                                </li>
                                <li>
                        ...
                        <li> <!--출고-->
                            ...
                            <ul class="b_header_nav_menu_medium">
                                ...
                                <li>
                                    <p><a href="./release_state_inquiry.jsp">출고요청처리현황</a></p>
                                </li>
                                <li>
                                    <p><a href="./release_pay.jsp">출고요청결제</a></p>
                                </li>
                                <li>
                                    <p><a href="./release_order_list.jsp">출고지시목록</a></p>
                                </li>
                            </ul>
                        </li> <!--출고끝-->
                        <li> <!--레시피-->
                            ...
                            <ul class="b_header_nav_menu_medium">
                                <li>
                                    <p><a href="./recipe_add.jsp">레시피추가</a></p>
                                </li>
                                <li>
                                    <p><a href="./recipe_inquiry.jsp">레시피목록</a></p>
                                </li>
                                <li>
                                    <p><a href="./recipe_detail.jsp">레시피상세보기</a></p>
                                </li>
                            </ul>
                        </li> <!--레시피 끝-->
                        <li class="b_header_nav_manager"> <!--관리자-->
                            <p><a href="./manager_main.jsp" class="b_header_nav_manager_btn">관리자페이지로 이동</a></p>
                        </li> <!--관리자 끝-->
                    </ul>
                </nav> <!--메뉴바 끝-->
            </section><!--.b_header_in-->
